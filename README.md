# @omegion1npm/ducimus-eaque-ullam
...
<a href="https://www.npmjs.com/package/@omegion1npm/ducimus-eaque-ullam">
  <img alt="npm version" src="https://img.shields.io/npm/v/@omegion1npm/ducimus-eaque-ullam.svg?style=flat-square" />
</a>
<a href="https://www.npmjs.com/package/@omegion1npm/ducimus-eaque-ullam">
  <img alt="npm downloads" src="https://img.shields.io/npm/dm/@omegion1npm/ducimus-eaque-ullam.svg?style=flat-square" />
</a>
...
```bash
# using npm
npm install -D @omegion1npm/ducimus-eaque-ullam
# using pnpm
pnpm install -D @omegion1npm/ducimus-eaque-ullam
# using yarn
yarn add --dev @omegion1npm/ducimus-eaque-ullam
```
...
```ts
import { svgSpritemap } from '@omegion1npm/ducimus-eaque-ullam';
